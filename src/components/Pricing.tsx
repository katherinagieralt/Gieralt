...
const plans = [
  {
    name: "Pakiet MVP",
    desc: "Dla startupów testujących rynek. Szybki start i weryfikacja pomysłu.",
    price: "2 500 PLN",
    time: "3 dni",
    features: [
  ...
  {
    name: "Pakiet Growth",
    desc: "Kompletny ekosystem sprzedaży dla Twojej firmy. Pełna optymalizacja pod konwersję.",
    price: "6 000 PLN",
    time: "7 dni",
    popular: true,
    features: [
  ...
  {
    name: "Pakiet Market Leader",
    desc: "Pełne wsparcie strategiczne, Design System i audyt UX. Dla liderów branży.",
    price: "16 000 PLN",
    time: "14 dni",
    features: [
