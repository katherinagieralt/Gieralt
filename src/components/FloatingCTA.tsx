    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div
          ...
          exit={{ opacity: 0, y: 50 }}
          className="fixed bottom-0 left-0 right-0 z-50 md:hidden px-4 pb-6 pt-4 bg-gradient-to-t from-white via-white/90 to-transparent dark:from-slate-950 dark:via-slate-950/90"
        >
          <button
          ...
          >
            ...
            <span className="uppercase tracking-widest text-sm">Umów darmową konsultację</span>
